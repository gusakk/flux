...
import (
	...
	fhttp "github.com/gusakk/flux/stdlib/http"
	...
	tests := []querytest.NewQueryTestCase{
		{
			...
			Raw: `
import "http"
from(bucket:"mybucket") |> http.to(url: "https://localhost:8081", name:"series1", method:"POST",  timeout: 50s)`,
			Want: &flux.Spec{
